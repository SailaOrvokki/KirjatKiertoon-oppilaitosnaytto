...
<div class="container" id="kirjailmoitustiedot">
    ...
    <h5>Kirjan tiedot</h5>
    <!-- Kirjatiedot lomake -->
    <form id="kirjatiedot" action="/lisää_kirja">

      <label for="kirjannimi">Kirjan nimi</label>
        <input type="text" id="nimi" name="nimi" placeholder="Anna kirjan nimi..">
      
      <label id="lataa">Lataa kuva</label>
        <input type="file" id="kuvaus" name="kuvat" multiple> <!--multiple = mhdollistaa useamman kuvan yhtäaikaisen lisäämisen -->
          <!-- <p>Poista kuva
        ...
        <label for="kuvaus">Kuvaus</label>
          <textarea id="kuvaus" name="kuvaus" placeholder="Kirjoita kirjasta kuvaus.." style="height:200px"></textarea>
        
        <label for="myyntihinta">Myyntihinta</label>
          <textarea id="myyntihinta" name="subject" placeholder="Kirjan myyntihinta..." style="height:200px"></textarea>
    
        <label for="myyntiaika">Myyntiaika</label>
          <textarea id="myyntiaika" name="myyntiaika" placeholder="Kirjan myyntiaika.." style="height:200px"></textarea>
